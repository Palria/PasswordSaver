...
//                    Toast.makeText(getApplicationContext(), "Sign in progress...!", Toast.LENGTH_SHORT).show();
                    ...
                    GlobalConfig.signInUserWithEmailAndPassword(SignInActivity.this, email, password, new GlobalConfig.SignInListener() {
                        ...
                        public void onSuccess(String email, String password) {
                            ...
                            GlobalConfig.keepMeLoggedIn(SignInActivity.this,keepMeLoggedInCheckBox.isChecked());
                            isInProgress = false;
                            //hide progress
                            Intent intent = new Intent(SignInActivity.this, MainActivity.class);
                            startActivity(intent);
                            Toast.makeText(getApplicationContext(), "You successfully signed in, go and save more of your passwords", Toast.LENGTH_LONG).show();
                            toggleProgress(false);
                            SignInActivity.super.onBackPressed();

                            GlobalConfig.updateActivityLog(GlobalConfig.ACTIVITY_LOG_USER_SIGN_IN_TYPE,  "", "",   new GlobalConfig.ActionCallback() {
                                @Override
...
//                    sign in is in progress
        ...
        keepMeLoggedInCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                GlobalConfig.keepMeLoggedIn(SignInActivity.this,b);
            }
        });
    }
    ...
    private void initUI(){
        ...
        keepMeLoggedInCheckBox = findViewById(R.id.keepMeLoggedInCheckBoxId);
