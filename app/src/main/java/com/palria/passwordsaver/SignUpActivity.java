...
//                                Toast.makeText(SignUpActivity.this, "up sign success", Toast.LENGTH_SHORT).show();
                                Toast.makeText(SignUpActivity.this, "SUCCEEDED to sign UP: ", Toast.LENGTH_LONG).show();
...
//                                        Toast.makeText(SignUpActivity.this, "sign in success", Toast.LENGTH_SHORT).show();
                                        Toast.makeText(SignUpActivity.this, "SUCCEEDED to sign in: ", Toast.LENGTH_LONG).show();
...
//                                                Toast.makeText(SignUpActivity.this, "profile success", Toast.LENGTH_SHORT).show();
                                                Toast.makeText(SignUpActivity.this, "PROFILE SUCCESS EDITION", Toast.LENGTH_LONG).show();
                                            ...
                                            public void onFailed(String errorMessage) { isInProgress = false;
                                                Toast.makeText(SignUpActivity.this, "failed to EDIT PROFILE: "+errorMessage, Toast.LENGTH_LONG).show();
                                        ...
                                        GlobalConfig.updateActivityLog(GlobalConfig.ACTIVITY_LOG_USER_SIGN_UP_TYPE, "", "", new GlobalConfig.ActionCallback() {
                                            @Override
                                    ...
                                    public void onFailed(String errorMessage) {
                                        isInProgress = false;
                                         Toast.makeText(SignUpActivity.this, "failed to sign in: "+errorMessage, Toast.LENGTH_LONG).show();
...
//    }
    ...
    private void createUserProfileInDatabase(String userId,ProfileCreationListener profileCreationListener){
        ...
        DocumentReference userProfileDocumentReference = GlobalConfig.getFirebaseFirestoreInstance().collection(GlobalConfig.ALL_USERS).document(userId);
        ...
        userProfileDetails.put(GlobalConfig.USER_PROFILE_DATE_CREATED_TIME_STAMP, FieldValue.serverTimestamp());
